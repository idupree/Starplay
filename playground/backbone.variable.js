/**
 * Backend for backbone.js that just uses a closure-global
 * variable as the storage.  This doesn't require a server
 * nor localStorage to be supported and enabled. (Some people
 * disable cookies+localStorage by default.)
 *
 * Modified-by-idupree version of:
 * Backbone localStorage Adapter
 * https://github.com/jeromegn/Backbone.localStorage
 */
(function(){
   var localStorage={
     getItem: function(key){return localStorage[key]},
     setItem: function(key, data){localStorage[key] = data},
